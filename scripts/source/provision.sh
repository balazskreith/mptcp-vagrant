...
set_source_routing_on_guest() {
  ...
  ip route add default via 192.168.33.100 dev eth1 table 1
  ...
  ip route add default via 192.168.34.100 dev eth2 table 2
...
sudo ip rule add from 192.168.53.10 table 1
...
sudo ip rule add from 192.168.54.10 table 2
...
#sudo sysctl net.mptcp.mptcp_path_manager=fullmesh
#iperf3 -c 192.168.53.100 -m eth1,eth2 -t 60 -p 5201 >iperf1.txt &
#sleep 5
#sudo sysctl net.mptcp.mptcp_path_manager=default
#iperf3 -c 192.168.53.100 -m eth1 -t 60 -p 5202 >iperf2.txt &
